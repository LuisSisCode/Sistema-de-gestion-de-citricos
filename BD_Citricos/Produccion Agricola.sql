...
CREATE TABLE Parcelas (
    ...
    activo BIT NOT NULL DEFAULT 1,
    geometria_point -- ya poseo en la base de datos, usa untipo de dato como GEOGRAPHY (utiliza las coordenadas y los transfomra en un punto fijo de la parcela para mostrar en el mapa)
    geometria_polygon -- Lo mismo que geometria_point pero esta echo para agregar geometrias y dibujar parcelas
