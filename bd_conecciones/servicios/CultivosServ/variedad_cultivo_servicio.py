...
import logging
from ...repositorios.CultivosRepositorio.variedad_cultivo_repositorio import VariedadCultivoRepositorio
from ...repositorios.CultivosRepositorio.tipo_cultivo_repositorio import TipoCultivoRepositorio
