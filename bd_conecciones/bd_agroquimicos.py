...
class GestorAgroquimicos:
    ...
    # CATEGORÍAS
    @cacheable('categorias_agroquimicos', ttl=7200)  # Categorías cambian poco
    ...
    @cache_invalidator('agroquimicos')  # Categorías afectan productos
    ...
    # MEZCLAS
    @cacheable('mezclas', ttl=get_ttl('agroquimicos'))
    def obtener_mezclas(self):
        ...
        try:
            ...
            return []
    @cacheable('mezclas', key_func=lambda id_mezcla: f"detalles_{id_mezcla}")
    ...
    @cacheable('tratamientos', ttl=600)  # Tratamientos son más dinámicos
    ...
    @cacheable('tipos_plagas', ttl=7200)  # Tipos de plagas cambian poco
    ...
    @cacheable('ciclos_activos', ttl=900)  # 15 minutos
