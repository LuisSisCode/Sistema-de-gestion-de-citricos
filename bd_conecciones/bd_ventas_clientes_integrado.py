...
from .nucleo.cache_system import cacheable, cache_invalidator, get_ttl, cache_manager
...
class GestorClientesVentas:
    ...
    def diagnosticar_cache_detallado(self):
        ...
        from .nucleo.cache_system import TTL_CONFIG
...
if __name__ == "__main__":
    ...
    from .nucleo.cache_system import print_cache_stats, clear_cache
