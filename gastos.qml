            ...
            Repeater {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        border.color: tabActiva === index ? tabsInfo[index].color : "#E0E0E0"
                        ...
                        // Sombra simple usando Rectangle sin GraphicalEffects
                        Rectangle {
                            ...
                            Row {
                                ...
                                Item {
                                    ...
                                    Rectangle {
                                        anchors.fill: parent
                                        radius: width / 2
                                        color: tabActiva === index ? tabsInfo[index].color : "#F5F5F5"
                                ...
                                Column {
                                    ...
                                    Text {
                                        ...
                                        color: tabActiva === index ? tabsInfo[index].color : "#616161"
                                    ...
                                    // Indicador de número o estado (opcional)
                                    Rectangle {
                                        width: 40
                                        height: 18
                                        radius: 9
                                        color: tabActiva === index ? tabsInfo[index].color : "#E0E0E0"
                                        opacity: tabActiva === index ? 1 : 0
                                        visible: tabActiva === index
