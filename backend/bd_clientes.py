...
class GestorClientes:
    ...
    def obtener_clientes(self):
        ...
        try:
            ...
            return []
    @cacheable('clientes', key_func=lambda id_cli: f"id_{id_cli}")
    ...
    def agregar_cliente(self, cliente_data):
        ...
        try:
            ...
            return False, None
    @cache_invalidator('clientes', pattern='id_')
    @cache_invalidator('estadisticas')
    ...
    @cacheable('clientes', key_func=lambda id_cli: f"historial_{id_cli}", ttl=900) 
    def obtener_historial_compras_cliente(self, id_cliente):
        ...
        try:
            ...
            return None
    @cacheable('clientes_clasificados', ttl=1800)
    def clasificar_clientes_por_volumen(self):
        try:
            ...
            return []   
    @cacheable('clientes_inactivos', key_func=lambda dias: f"inactivos_{dias}", ttl=1800)
